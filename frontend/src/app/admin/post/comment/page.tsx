...
export default function AdminPostCommentPage() {
      ...
      <div className="rounded-[2.5rem] border border-white bg-white/70 p-8 shadow-2xl shadow-slate-200/40 backdrop-blur-xl">
        <div className="space-y-3">
          <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] text-primary">
            ...
            Community Reply Moderation
          </div>
          <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">社区回复审核</h1>
          <p className="text-lg font-medium text-slate-500">处理帖子下自动审核未通过的评论与二级回复，决定通过或驳回，并向用户发送通知。</p>
        </div>
      </div>
